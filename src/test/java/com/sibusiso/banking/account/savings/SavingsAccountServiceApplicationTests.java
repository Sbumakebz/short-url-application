...
class SavingsAccountServiceApplicationTests {
	...
	public void setAccountNumber() {
		...
		System.out.println(eurekaClient.getNextServerFromEureka("SAVINGS-ACCOUNT-CLIENT", false));
		url = eurekaClient.getNextServerFromEureka("SAVINGS-ACCOUNT-CLIENT", false).getHomePageUrl();
